...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-800 mb-2">➕ Tambah Data Kelompok</h1>
            <p class="text-gray-600">Silakan isi data kelompok dengan lengkap dan benar.</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
                <form action="{{ route('kelompok.data-kelompok.store') }}" method="POST" enctype="multipart/form-data" id="kelompokForm">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-3 rounded-lg">
                            <p class="text-sm text-blue-800 flex items-start">
                                ...
                                <span><strong>Klik pada peta</strong> di sebelah kanan untuk menandai lokasi. Koordinat akan terisi otomatis!</span>
                            </p>
                        </div>
                    ...
                    <div class="flex justify-end gap-4 pt-4 border-t border-gray-200">
                        ...
                        <button type="submit"
                            class="px-6 py-3 rounded-xl bg-green-600 hover:bg-green-700 text-white font-semibold shadow-md hover:shadow-xl transition-all duration-300">
                            💾 Simpan Data
                        </button>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 border border-gray-100 sticky top-6">
                <div class="mb-4">
                    ...
                    <p class="text-sm text-gray-600">Klik pada peta untuk menandai lokasi kelompok</p>
                </div>
...
const map = L.map('map').setView([-7.0876, 110.9779], 13);
