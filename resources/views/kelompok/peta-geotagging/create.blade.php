...
@section('title', 'Upload Peta Geotagging - Sistem KBR')
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 flex items-center gap-2">
                ...
                Upload Peta Geotagging Baru
            </h1>
            <p class="text-gray-600 mt-2">Upload 1-5 file PDF peta geotagging dalam satu data</p>
        </div>
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <ul class="text-sm text-blue-700 mt-1 list-disc list-inside space-y-1">
                        ...
                        <li>Setiap upload akan menjadi satu data peta geotagging</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            <form action="{{ route('kelompok.peta-geotagging.store') }}" method="POST" enctype="multipart/form-data" id="uploadForm">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea name="keterangan" 
                              ...
                              rows="4"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all"
                              placeholder="Tambahkan keterangan tentang peta geotagging ini...">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
