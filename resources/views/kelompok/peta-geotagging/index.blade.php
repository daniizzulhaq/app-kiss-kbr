...
@section('title', 'Data Peta Geotagging - Sistem KBR')
...
<div class="container mx-auto px-4 py-6 sm:py-8">
        ...
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
                ...
                <p class="text-sm sm:text-base text-gray-600 mt-1">
                    Kelola peta geotagging kelompok <strong class="text-green-600">{{ $kelompok->nama_kelompok }}</strong>
                </p>
            </div>
            <a href="{{ route('kelompok.peta-geotagging.create') }}" 
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-xs sm:text-sm text-blue-700 mt-1">
                        Upload 1-5 file PDF peta geotagging sekaligus dalam 1 data. Setiap upload akan diverifikasi oleh BPDAS.
                    </p>
                </div>
            </div>
        </div>
    ...
    <!-- Summary Cards -->
    @php
        $dataPeta = $petaGeotagging ?? collect();
                    ...
                    <tr class="hover:bg-green-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <div class="flex justify-center gap-2">
                                <a href="{{ route('kelompok.peta-geotagging.show', $peta) }}" 
                                ...
                                @if($peta->status !== 'diterima')
                                    <a href="{{ route('kelompok.peta-geotagging.edit', $peta) }}" 
                                ...
                                <form action="{{ route('kelompok.peta-geotagging.destroy', $peta) }}" 
                                      method="POST" 
                                      onsubmit="return confirm('Yakin ingin menghapus peta geotagging \"{{ $peta->judul }}\" beserta {{ $peta->file_count }} file PDF?')"
                                      class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" 
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <h3 class="text-2xl font-medium text-gray-900 mb-2">Belum ada peta geotagging</h3>
                                <p class="text-sm text-gray-500 mb-6">Mulai upload peta geotagging kelompok Anda.</p>
                                <a href="{{ route('kelompok.peta-geotagging.create') }}" 
    ...
    <div class="lg:hidden space-y-4">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <p class="text-gray-500 font-medium text-base mb-2">Belum ada peta geotagging</p>
            <p class="text-gray-400 text-sm mb-4">Mulai upload 1-5 file PDF peta geotagging kelompok Anda</p>
            <a href="{{ route('kelompok.peta-geotagging.create') }}" 
