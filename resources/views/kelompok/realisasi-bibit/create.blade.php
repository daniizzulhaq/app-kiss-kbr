...
<div class="container mx-auto px-3 sm:px-4 py-4 sm:py-8 max-w-3xl">
    ...
    <div class="mb-4 sm:mb-6">
        <a href="{{ route('kelompok.realisasi-bibit.index') }}" 
           class="text-green-600 hover:text-green-800 font-medium flex items-center gap-2 mb-3 sm:mb-4 text-sm sm:text-base">
            <span>←</span> Kembali
        </a>
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Tambah Realisasi Bibit</h1>
        <p class="text-gray-600 mt-1 text-sm sm:text-base">Masukkan data realisasi bibit yang telah direalisasikan</p>
    </div>
        ...
        <form action="{{ route('kelompok.realisasi-bibit.store') }}" method="POST">
            ...
            <div class="mb-4 sm:mb-6">
                ...
                <input type="text" 
                       ...
                       class="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent @error('jenis_bibit') border-red-500 @enderror"
            ...
            <div class="mb-4 sm:mb-6">
                ...
                <select name="golongan" 
                        id="golongan"
                        class="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent @error('golongan') border-red-500 @enderror">
            ...
            <div class="mb-4 sm:mb-6">
                ...
                <input type="number" 
                       ...
                       class="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent @error('jumlah_btg') border-red-500 @enderror"
            ...
            <div class="mb-4 sm:mb-6">
                ...
                <input type="number" 
                       ...
                       value="{{ old('tinggi') }}"
                       step="0.01"
                       class="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent @error('tinggi') border-red-500 @enderror"
            ...
            <div class="mb-4 sm:mb-6">
                ...
                <input type="text" 
                       ...
                       class="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent @error('sertifikat') border-red-500 @enderror"
