...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-6 sm:mb-8 slide-in">
        ...
        <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 mb-2">🌱 Tambah Rencana Bibit</h1>
        <p class="text-sm sm:text-base text-gray-600">Isi form berikut untuk menambahkan rencana kebutuhan bibit baru</p>
    </div>
